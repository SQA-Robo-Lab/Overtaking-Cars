...
#define MESSAGE_OVERTAKINGCOORDINATIONMESSAGESREQUESTOVERTAKINGOVERTAKINGCOORDINATIONMESSAGESMESSAGE 7 /**< ECU Identifier: For the Message-Type: requestOvertaking */
