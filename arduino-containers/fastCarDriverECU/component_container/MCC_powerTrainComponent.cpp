		...
		*/ 
		typedef struct powerTrainComponent_Builder {
				...
				/*void (*velocityPortInitFunction)(); /**initialization function pointer for continuous port */
				/*void (*velocityPortTerminateFunction)(); /**destruction function pointer for continuous port */
		...
		*/
		static const powerTrainComponent_Builder INIT_BUILDER = { 0,  PORT_DEACTIVATED, NULL, .VELOCITY_op.local_option={0,0}   };
		/**
		*
		...
		*/
		...
		PowerTrainComponent* MCC_create_PowerTrainComponent(uint8_T ID){
			...
			switch(ID){
				case CI_POWERTRAINFPOWERTRAIN:
					b.ID = ID;
						b.velocityPortAccessFunction=&CI_POWERTRAINFPOWERTRAINvelocityPortaccessCommand;
							b.VELOCITY = PORT_ACTIVE;
							b.createVELOCITYHandle = &create_VELOCITYLocalHandle;
							b.VELOCITY_op.local_option.pubID = -26371;
							b.VELOCITY_op.local_option.subID = -25132;
				break;
			default:
				break;
			}
