...
*/
#define CI_POWERTRAINFPOWERTRAIN 1 /**< Identifier for Component Instance powerTrain.F */
#define CI_DRIVECONTROLFDRIVECONTROL 2 /**< Identifier for Component Instance driveControl.F */
