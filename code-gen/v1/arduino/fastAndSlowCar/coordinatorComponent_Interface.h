 ...
 *
 */
typedef struct CoordinatorCoordinator Componen
tStateChart CoordinatorCoordinatorComponentStateChart;
/**
 * @brief Forward Declarat ion of t
he struct CoordinatorComponent
*/
typedef struct CoordinatorComponent CoordinatorCo mponent;
/**
 *
...
struct CoordinatorComponent {
	...
	CoordinatorCoord inatorCom
	ponentStateChart* stateChart; /**< The CoordinatorCoordinatorComponentStateChart of the Component Coordinator */

	Port* communicatorPort; /**< A Pointer to the Co mponent
	'sPort: commun icator
	*/
	Port* overtakingInitiatorPort; /**< A Pointer to the Component's Port: overtakingInitiator */
	Port* overtakingAffiliatePort; /**< A Pointer to the Component's Port: overtakingAffiliate */
