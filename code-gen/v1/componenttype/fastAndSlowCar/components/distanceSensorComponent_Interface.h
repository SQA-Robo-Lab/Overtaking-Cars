	...
	#include "../lib/Debug.h"
			/*****
 			 ...
 			 */		
						...
						void MCC_DistanceSensorComponent_distance_send_value(Port* p, double_T* value);
			 ...
			 */
						...
						*/
						struct DistanceSensorComponent {
								...
								uint8_T ID;	
									...
									void (*distancePortAccessFunction) (double_T*); /**access function pointer for continuous port */
									/*FIXME: Add InitFunction and Destory Funcion */
						
									double_T distance; /*A Ports Data Variable*/
						...
						*/
						...
						/*Getter and Setter for Sending Values of Hybrid/Continuous ports*/
									void setterOf_distance(Port* distancePort, double_T* distance);/**< A Pointer to the setter function of the port: distance */
