		...
		*/ 
		typedef struct distanceSensorComponent_Builder {
				...
				/*void (*distancePortInitFunction)(); /**initialization function pointer for continuous port */
				/*void (*distancePortTerminateFunction)(); /**destruction function pointer for continuous port */
		...
		*/
		static const distanceSensorComponent_Builder INIT_BUILDER = { 0,  PORT_DEACTIVATED, NULL, .DISTANCE_op.local_option={0,0}   };
		/**
		*
		...
		*/
		...
		DistanceSensorComponent* MCC_create_DistanceSensorComponent(uint8_T ID){
			...
			switch(ID){
				case CI_FRONTDISTANCESENSORSDISTANCESENSOR:
					b.ID = ID;
						b.distancePortAccessFunction=&CI_FRONTDISTANCESENSORSDISTANCESENSORdistancePortaccessCommand;
							b.DISTANCE = PORT_ACTIVE;
							b.createDISTANCEHandle = &create_DISTANCELocalHandle;
							b.DISTANCE_op.local_option.pubID = 3192;
							b.DISTANCE_op.local_option.subID = 12012;
				break;
				case CI_REARDISTANCESENSORSDISTANCESENSOR:
					b.ID = ID;
						b.distancePortAccessFunction=&CI_REARDISTANCESENSORSDISTANCESENSORdistancePortaccessCommand;
							b.DISTANCE = PORT_ACTIVE;
							b.createDISTANCEHandle = &create_DISTANCELocalHandle;
							b.DISTANCE_op.local_option.pubID = -30463;
							b.DISTANCE_op.local_option.subID = 19917;
				break;
			default:
				break;
			}
