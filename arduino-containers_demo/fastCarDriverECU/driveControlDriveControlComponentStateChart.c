	...
	DriveControlDriveControlComponentStateChart *stateChart)
{
	...
	stateChart->desiredVelocity = stateChart->desiredVelocity = 80;
	;
	...
	DriveControlDriveControlComponentStateChart *stateChart)
{
	...
	case STATE_DRIVECONTROLDRIVECONTROLWAITFORPERMISSION:
		if ((stateChart->DriveControlDriveControl_mainDriving_isExecutable) && (stateChart->currentStateOfDriveControlDriveControl_mainDriving == STATE_DRIVECONTROLDRIVECONTROL_MAINDRIVINGFOLLOWMAINLANE))
		{
	...
	case STATE_DRIVECONTROLDRIVECONTROLOVERTAKING:
		if ((stateChart->DriveControlDriveControl_mainDriving_isExecutable) && (stateChart->currentStateOfDriveControlDriveControl_mainDriving == STATE_DRIVECONTROLDRIVECONTROL_MAINDRIVINGCOMPLETEOVERTAKING))
		{
...
{
	return (stateChart->currentStateOfDriveControlDriveControl_mainDriving == state || stateChart->currentStateOfDriveControlDriveControlDriveControlPort == state);
}
