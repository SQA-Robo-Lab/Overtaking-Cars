	...
	CoordinatorCoordinatorComponentStateChart *stateChart)
{
	...
	case STATE_COORDINATORCOMMUNICATORIDLE:
		if ((stateChart->CoordinatorOvertakingInitiatorOvertakingInitiatorPort_isExecutable) && (stateChart->currentStateOfCoordinatorOvertakingInitiatorOvertakingInitiatorPort == STATE_COORDINATOROVERTAKINGINITIATORIDLE))
		{
			if (
	...
	case STATE_COORDINATORCOMMUNICATORWAITFORCOORDINATION:
		if ((stateChart->CoordinatorOvertakingInitiatorOvertakingInitiatorPort_isExecutable) && (stateChart->currentStateOfCoordinatorOvertakingInitiatorOvertakingInitiatorPort == STATE_COORDINATOROVERTAKINGINITIATORINITIATING))
		{

			if (

				Clock_getTime(
					stateChart->coordinatorCoordinationTimeCoordinatorCoordinatorComponentClock) > stateChart->coordinationTimeout * 1000.0
		...
		else if ((stateChart->CoordinatorOvertakingInitiatorOvertakingInitiatorPort_isExecutable) && (stateChart->currentStateOfCoordinatorOvertakingInitiatorOvertakingInitiatorPort == STATE_COORDINATOROVERTAKINGINITIATORINITIATING))
		{
	...
	case STATE_COORDINATORCOMMUNICATORWAITFOROVERTAKING:
		if ((stateChart->CoordinatorOvertakingInitiatorOvertakingInitiatorPort_isExecutable) && (stateChart->currentStateOfCoordinatorOvertakingInitiatorOvertakingInitiatorPort == STATE_COORDINATOROVERTAKINGINITIATORPASSING))
		{
...
{
	return (stateChart->currentStateOfCoordinatorCommunicatorCommunicatorPort == state || stateChart->currentStateOfCoordinatorOvertakingInitiatorOvertakingInitiatorPort == state || stateChart->currentStateOfCoordinatorOvertakingAffiliateOvertakingAffiliatePort == state);
}
