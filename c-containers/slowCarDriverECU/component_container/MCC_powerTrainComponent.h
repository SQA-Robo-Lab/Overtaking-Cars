  ...
  extern "C" {
				...
				#include "../APImappings/CI_POWERTRAINSPOWERTRAINvelocityPortaccessCommand.h"
			 ...
			 */
									 ...
									 * @details The method for initializing and creating a component instance oc type: Atomic_Component_PowerTrain
									 */
