			...
			#include "MCC_coordinatorComponent.h"
								...
								* @details Thes options are used in the struct coordinatorComponent_Builder
								*/ 
			struct port_option {
			union {
				struct{
		...
		*/
			...
			static int pool_index = 0;
									...
									*/	
									...
									/**
									*
									*@brief The Receiv method for DiscretePort communicator  and message OvertakingPermissionMessagesRequestPermission
									...
									*/	
									...
									/**
									*
									*@brief The Receiv method for DiscretePort communicator  and message OvertakingPermissionMessagesExecutedOvertaking
								...
								*/	
									...
									*/	
									...
									/**
									*
									*@brief The Receiv method for DiscretePort overtakingInitiator  and message OvertakingCoordinationMessagesAcceptOvertaking
								...
								*/	
									...
									*/	
									...
									/**
									*
									*@brief The Receiv method for DiscretePort overtakingAffiliate  and message OvertakingCoordinationMessagesRequestOvertaking
									...
									*/	
									...
									/**
									*
									*@brief The Receiv method for DiscretePort overtakingAffiliate  and message OvertakingCoordinationMessagesFinishedOvertaking
